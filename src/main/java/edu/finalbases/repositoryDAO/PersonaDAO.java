...
public class PersonaDAO extends AbstractDAO {
    ...
    public int crear(Object object) throws SQLException, FException {
        ...
        try {
            ...
            throw new FException("PersonaDAO", "No se puede crear el cliente, " + e.getMessage());
        } finally {
    ...
    public int updateConexion(Persona p) throws SQLException, FException {
        ...
        try {
            ...
            throw new FException("PersonaDAO", "No se pudo actualizar la ultima conexión" + e.getMessage());
        } finally {
            Conexion.getInstance().cerrarConexion();
        }
    ...
    public boolean crearUser(Persona p) throws SQLException, FException {
        ...
        try {
            ...
            throw new FException("PersonaDAO", "Error al crear user en DB, " + ex.getMessage());
        } finally {
            Conexion.getInstance().cerrarConexion();
        }
