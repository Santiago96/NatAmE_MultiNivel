                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane" id="s2">
                        ...
                        <div id="bancos">
                            ...
                            <div class="form-group">
                                <input type="number" name="numDocumentoP" class="form-control" id="numDocumentoP" placeholder="Número Documento" oninvalid="this.setCustomValidity('Ingrese un Número de documento válido')" oninput="setCustomValidity('')" required>
                            </div>
