...
GRANT CONNECT, CREATE TABLE, CREATE SEQUENCE, CREATE VIEW, CREATE ANY PROCEDURE,CREATE ANY DIRECTORY, CREATE ANY TRIGGER, CREATE PUBLIC SYNONYM TO R_MULTINIVEL;
