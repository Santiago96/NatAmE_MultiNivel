...
/*  Created On : 11-abr-2018 8:53:57 PM 				*/
/*  DBMS       : Oracle 						*/
/* ---------------------------------------------------- */
...
(
	...
	"DETALLECALIFICACION" VARCHAR(50) NULL,
	"IDVENTA" NUMBER(4) NOT NULL,
	"FECHA" DATE NULL
)
;
...
/* CREATE SEQUENCE "SEQ_HISTORICOTIPOREP_IDHISTORICOTIPOREP" */
...
/* CREATE SEQUENCE "SEQ_HISTORICOCRV_IDHISTORICOCRV" */
...
/* CREATE SEQUENCE "SEQ_CALIFICACIONVENTA_IDCALIFICACIONVENTA"*/
...
/* CREATE SEQUENCE "SEQ_CALIFICACION_IDCALIFICACION" */
CREATE SEQUENCE "SEQ_CALIFICACION_ID" 
	INCREMENT BY 1 
	START WITH 1 
	NOMAXVALUE 
	MINVALUE  1 
...
ALTER TABLE "DETALLEPAGO" 
 ADD CONSTRAINT "CK_TIPODEPAGO" CHECK (TIPODEPAGO IN ('PSE','TARJETA DE CREDITO'))
;
...
ALTER TABLE "CALIFICACION" 
 ADD CONSTRAINT "FK_CALIFICACION_CLIENTE"
	FOREIGN KEY ("IDCLIENTE") REFERENCES "CLIENTE" ("IDCLIENTE")
;
