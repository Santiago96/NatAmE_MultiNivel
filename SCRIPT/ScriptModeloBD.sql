...
(
	...
	"VARIABLEMODIFICADA" VARCHAR2(20) NOT NULL,
	"VALORANTIGUO" VARCHAR2(20) NOT NULL,
	"VALORNUEVO" VARCHAR2(20) NOT NULL,
...
CREATE SEQUENCE  "MULTINIVEL"."SEQ_AUDITORIA_IDAUDITORIA"  
	INCREMENT BY 1 
	START WITH 1 
	NOMAXVALUE
	MINVALUE 1
