...
/*  Created On : 10-mar.-2018 11:28:43 a. m. 				*/
/*  DBMS       : Oracle 						*/
/* ---------------------------------------------------- */
...
(
	...
	"IDREPRESENTANTE" NUMBER(3) NOT NULL,
...
(
	...
	"IDPAIS" NUMBER(2) NOT NULL,
	"IDREGION" NUMBER(2) NOT NULL,
	"IDREPRESENTANTECLIENTE" NUMBER(3) NULL,
...
CREATE SEQUENCE "SEQ_TIPORPTEVENTAS_IDTIPORPTE" 
	INCREMENT BY 1 
	START WITH 1 
	NOMAXVALUE 
	MINVALUE  1 
...
CREATE SEQUENCE "SEQ_TIPOCTO_IDTIPOCTO" 
	INCREMENT BY 1 
	START WITH 1 
	NOMAXVALUE 
	MINVALUE  1 
...
CREATE SEQUENCE "SEQ_SUBCRIA_IDSUBCRIA" 
	INCREMENT BY 1 
	START WITH 1 
	NOMAXVALUE 
	MINVALUE  1 
...
CREATE SEQUENCE "SEQ_DETALLEVTA_IDDETALLEVTA" 
	INCREMENT BY 1 
	START WITH 1 
	NOMAXVALUE 
	MINVALUE  1 
...
ALTER TABLE "CATEGORIA" 
 ADD CONSTRAINT "UK_CATEGORIA" UNIQUE ("IDCATEGORIA","IDSUBCATEGORIA") USING INDEX
;
